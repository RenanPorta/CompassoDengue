...
function render(input, out, __component, component, state) {
  ...
  out.w("<header><nav class=\"navbar navbar-expand-lg navbar-light identidade-visual\"><a class=\"navbar-brand logo\" href=\"#\"><img src=\"/estatico/img/logo.png\" alt=\"\"></a><div class=\"ml-auto\"><a class=\"btn btn-danger text-white\" href=\"/funcionario-consulta\">Voltar</a></div></nav></header><main class=\"container\"><h1 class=\"text-center display-4 py-4\">Altera Funcionario</h1><form name=\"alteraFuncionario\" method=\"post\" action=\"/funcionario-altera\"><input class=\"form-control\" type=\"hidden\" name=\"_method\" value=\"PUT\"><input class=\"form-control\" type=\"hidden\" id=\"id\" name=\"id\" value=\"" +
    ...
    "\"></div><div class=\"form-group\"><label for=\"telefoneFuncionario\">Telefone</label><input class=\"form-control\" type=\"text\" id=\"telefoneFuncionario\" name=\"telefoneFuncionario\" value=\"" +
    marko_escapeXmlAttr(data.funcionario.telefone) +
    "\" maxlength=\"11\"></div><div class=\"form-group\"><label for=\"emailFuncionario\">E-mail</label><input class=\"form-control\" type=\"email\" id=\"emailFuncionario\" name=\"emailFuncionario\" value=\"" +
