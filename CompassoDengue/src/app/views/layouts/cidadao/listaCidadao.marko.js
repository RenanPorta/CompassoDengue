...
var marko_template = module.exports = require("marko/src/html").t(__filename),
    marko_componentType = "/app-dengue$1.0.0/src/app/views/layouts/cidadao/listaCidadao.marko",
...
function render(input, out, __component, component, state) {
  ...
  out.w("<header><nav class=\"navbar navbar-expand-lg navbar-light identidade-visual\"><a class=\"navbar-brand logo\" href=\"#\"><img src=\"/estatico/img/logo.png\" alt=\"\"></a><div class=\"ml-auto\"><a class=\"btn btn-danger text-white\" href=\"/home\">Voltar</a></div></nav></header><main class=\"container\"><h1 class=\"text-center display-4 py-4\">Listagem de Cidadãos</h1><table class=\"table table-bordered table-hover table-responsive-lg\" id=\"cidadaos\"><thead class=\"thead-light\"><tr class=\"text-center\"><th>Nome</th><th>ID</th><th>CPF</th><th>Telefone</th><th>Email</th></tr></thead><tbody>");
...
marko_template.meta = {
    id: "/app-dengue$1.0.0/src/app/views/layouts/cidadao/listaCidadao.marko",
    tags: [
