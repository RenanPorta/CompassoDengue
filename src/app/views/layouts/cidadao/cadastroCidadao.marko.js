...
function render(input, out, __component, component, state) {
  ...
  out.w("<header><nav class=\"navbar navbar-expand-lg navbar-light identidade-visual\"><a class=\"navbar-brand logo\" href=\"#\"><img src=\"../../../public/img/logo.png\" alt=\"\"></a><div class=\"ml-auto\"><a class=\"btn btn-danger text-white\" href=\"index.html\">Voltar</a></div></nav></header><main class=\"container\"><div class=\"py-5\"><h4 class=\"text-center\">Cadastro de Cidadão</h4><form name=\"cadastraCidadao\" method=\"post\" action=\"/cidadao\"><input class=\"form-control\" type=\"hidden\" id=\"id\" name=\"id\"><div class=\"row\"><div class=\"form-group col-md-6 mb-3\"><label for=\"nomeCidadao\">Nome</label><input class=\"form-control\" type=\"text\" id=\"nomeCidadao\" name=\"nomeCidadao\"></div><div class=\"form-group col-md-6 mb-3\"><label for=\"cpfCidadao\">CPF</label><input class=\"form-control\" type=\"text\" id=\"cpfCidadao\" name=\"cpfCidadao\" placeholder=\"999.999.999-99\" pattern=\".{11,}\" required></div></div><div class=\"row\"><div class=\"form-group col-md-6 mb-3\"><label for=\"telefoneCidadao\">Telefone</label><input class=\"form-control\" type=\"text\" id=\"telefoneCidadao\" name=\"telefoneCidadao\" placeholder=\"(99)99999-9999\" pattern=\"[0-9]{2}-[0-9]{5}-[0-9]{4}\" required></div><div class=\"form-group col-md-6 mb-3\"><label for=\"emailCidadao\">E-mail</label><input class=\"form-control\" type=\"email\" id=\"emailCidadao\" name=\"emailCidadao\"></div></div><div class=\"row\"><div class=\"form-group col-md-6 mb-3\"><label for=\"senhaCidadao\">Senha</label><input class=\"form-control\" type=\"password\" id=\"senhaCidadao\" name=\"senhaCidadao\"></div><div class=\"form-group col-md-6 mb-3\"><label for=\"confirmaSenhaCidadao\">Confirmar Senha</label><input class=\"form-control\" type=\"password\" id=\"confirmaSenhaCidadao\" name=\"confirmaSenhaCidadao\"></div></div><button class=\"btn btn-primary\" type=\"submit\" onclick=\"return validar()\">Cadastrar</button></form></div></main><footer><div class=\"jumbotron mb-0 identidade-visual\"><img class=\"logo-footer mx-auto d-block img-fluid\" src=\"../../../public/img/logo-2.png\" alt=\"\"><p class=\"copyright text-center mb-0\">Copyright © 2020 | Todos os direitos reservados. Prefeitura de Mogi Mirim.</p><p class=\"copyright text-center\">Rua Doutor José Alves, 129 - Centro - 13800-900 - Mogi Mirim - SP - Brasil. Tel.19 3814.1000</p></div></footer><script type=\"text/javascript\">\r\n        function validar() {\r\n            var senha = cadastraCidadao.senhaCidadao.value;\r\n            var confirmaSenha = cadastraCidadao.confirmaSenhaCidadao.value;\r\n\r\n            if (senha == \"\" || senha.length <= 5) {\r\n                alert('Preencha o campo \"Senha\" com no minímo 6 caracteres');\r\n                cadastraCidadao.senhaCidadao.focus();\r\n                return false;\r\n            }\r\n\r\n            if (confirmaSenha == \"\") {\r\n                alert('Preencha o campo \"Confirmar Senha\"');\r\n                cadastraCidadao.confirmaSenhaCidadao.focus();\r\n                return false;\r\n            }\r\n\r\n            if (senha != confirmaSenha) {\r\n                alert('Senhas diferentes!');\r\n                cadastraCidadao.confirmaSenhaCidadao.focus();\r\n                return false;\r\n            }\r\n        }\r\n    </script>");
